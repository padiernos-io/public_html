 ...
 * @endcode
 */
$databases['default']['default'] = array('driver' => 'mysql', 'database' => 'padiernos', 'username' => 'padiernos', 'password' => 'voWr0rOlMwZrKhcdWl47', 'host' => 'localhost', 'prefix' => 'drupal_');
 ...
 * @endcode
 */
$settings['hash_salt'] = 'YmpLXLpnd1I5hbdhf7ngMJOVQtJ6mV_syMKIs78XBan2CoheItfpYxQMiHH9g9CKF2tMOTeXBg';
...
if (file_exists($app_root . '/modules/contrib/dev_mode/settings.dev_mode.php')) {
  include $app_root . '/' . $site_path . '/settings/local/settings.globals.php';
