...
Extra Paragraph Types (EPT): Columns / Container is boilerplate for EPT module.
...
[project page](https://www.drupal.org/project/ept_columns).

Submit bug reports and feature suggestions, or track changes in the
[issue queue](https://www.drupal.org/project/issues/ept_columns).
