...
namespace Drupal\Tests\ept_columns\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_columns'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_columns']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_columns');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_columns'));
