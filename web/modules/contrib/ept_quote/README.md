...
Extra Paragraph Types: Quote module provides ability
to add Quote with Image and testimonial.
It can be useful for persona quote or client testimonials.

For a full description of the module, visit the
[project page](https://www.drupal.org/project/ept_quote).

Submit bug reports and feature suggestions, or track changes in the
[issue queue](https://www.drupal.org/project/issues/ept_quote).
