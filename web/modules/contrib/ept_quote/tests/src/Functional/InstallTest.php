...
namespace Drupal\Tests\ept_quote\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_quote'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_quote']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_quote');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_quote'));
