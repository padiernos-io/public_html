...
# Extra Paragraph Types (EPT): Counter

Extra Paragraph Types: Counter module provides ability
to add Number Counter and Text with WYSIWYG editor.

For a full description of the module, visit the
[project page](https://www.drupal.org/project/ept_counter).

Submit bug reports and feature suggestions, or track changes in the
[issue queue](https://www.drupal.org/project/issues/ept_counter).
...
- If you use Field Layout module,
  ...
  `/admin/structure/paragraph/paragraph-content/manage/ept_counter/display/default`
