...
namespace Drupal\Tests\ept_counter\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_counter'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_counter']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_counter');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_counter'));
