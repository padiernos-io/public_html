...
# Extra Paragraph Types (EPT): Timeline

Extra Paragraph Types: Timeline module provides ability
to add a paragraph with timeline.

For a full description of the module, visit the
[project page](drupal.org/project/ept_timeline12).

Submit bug reports and feature suggestions, or track changes in the
[issue queue](https://www.drupal.org/project/issues/ept_timeline).
...
- If you see the error during EPT modules installation:
  "The EPT Timeline needs to be created "Image" media type.
