...
namespace Drupal\Tests\ept_timeline\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_timeline'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_timeline']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_timeline');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_timeline'));
