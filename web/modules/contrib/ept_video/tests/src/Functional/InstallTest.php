...
namespace Drupal\Tests\ept_video\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_video'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_video']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_video');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_video'));
