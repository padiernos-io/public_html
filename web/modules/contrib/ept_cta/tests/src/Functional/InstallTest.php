...
namespace Drupal\Tests\ept_cta\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_cta'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_cta']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_cta');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_cta'));
