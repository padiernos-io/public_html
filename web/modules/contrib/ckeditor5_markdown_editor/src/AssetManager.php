...
namespace Drupal\ckeditor5_markdown_editor;
...
class AssetManager {
  /**
   * Drupal\ckeditor5_markdown_editor\libraryVersion definition.
   *
   * @var string
   */
  ...
  /**
   * Drupal\ckeditor5_markdown_editor\packageName definition.
   *
   * @var string
   */
  private static $packageName= '@ckeditor/ckeditor5-markdown-gfm';

  /**
   * Drupal\ckeditor5_markdown_editor\packagePrefix definition.
   *
   * @var string
   */
  private static $packagePrefix = 'ckeditor5-markdown-gfm';

  /**
   * Drupal\ckeditor5_markdown_editor\ckeditorName definition.
   *
   * @var string
   */
   ...
   *   information about ckeditor5 markdown output.
   * @param string $path
  ...
  public static function getCKEditorVersion(LibraryDiscoveryInterface $library_discovery, ConfigFactory $config_factory, $path = 'core', $extension = 'core') {
    $config_version = $config_factory->get('ckeditor5_markdown_editor.settings')->get('ckeditor_version');
  ...
  public static function getPluginsInstalledVersion(ConfigFactory $config_factory) {
    return $config_factory->get('ckeditor5_markdown_editor.settings')->get('plugins_version_installed');
  }
