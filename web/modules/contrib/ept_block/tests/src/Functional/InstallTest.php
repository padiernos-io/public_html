...
namespace Drupal\Tests\ept_block\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_block'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_block']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_block');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_block'));
