...
namespace Drupal\Tests\ept_text\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_text'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_text']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_text');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_text'));
