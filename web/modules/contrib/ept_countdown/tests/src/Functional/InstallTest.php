...
namespace Drupal\Tests\ept_countdown\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_countdown'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_countdown']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_countdown');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_countdown'));
