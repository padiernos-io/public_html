...
Extra Paragraph Types: Accordion module provides ability
 ...
 * If you use Field Layout module,
   ...
   /admin/structure/block/block-content/manage/ept_accordion/display/default
...
EPT: Accordion module tends to be flexible.
