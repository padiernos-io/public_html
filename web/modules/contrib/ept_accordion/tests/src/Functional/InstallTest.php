...
namespace Drupal\Tests\ept_accordion\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_accordion'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_accordion']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_accordion');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_accordion'));
    ...
    // Load the front page.
    $this->drupalGet('block/add/ept_accordion');
