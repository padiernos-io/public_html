...
namespace Drupal\Tests\ept_carousel\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_carousel'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_carousel']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_carousel');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_carousel'));
