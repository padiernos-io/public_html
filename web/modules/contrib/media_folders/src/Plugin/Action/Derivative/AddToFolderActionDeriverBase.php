 ...
 */
abstract class AddToFolderActionDeriverBase extends DeriverBase implements ContainerDeriverInterface {
  ...
  /**
   * Constructs a new AddToFolderActionDeriverBase object.
   *
