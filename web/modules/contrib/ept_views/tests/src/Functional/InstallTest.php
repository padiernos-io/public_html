...
namespace Drupal\Tests\ept_views\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_views'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_views']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_views');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_views'));
