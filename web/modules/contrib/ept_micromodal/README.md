...
Extra Paragraph Types: Micromodal module provides ability to add Text and Title with
WYSIWYG editor.
...
After enable this project will be available a new paragraph type called `EPT Micromodal`
