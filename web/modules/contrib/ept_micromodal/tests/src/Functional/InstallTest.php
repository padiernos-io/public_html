...
namespace Drupal\Tests\ept_micromodal\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_micromodal'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_micromodal']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_micromodal');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_micromodal'));
