...
namespace Drupal\Tests\ept_webform_popup\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_webform_popup'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_webform_popup']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_webform_popup');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_webform_popup'));
