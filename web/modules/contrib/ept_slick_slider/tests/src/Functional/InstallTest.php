...
namespace Drupal\Tests\ept_slick_slider\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_slick_slider'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_slick_slider']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_slick_slider');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_slick_slider'));
