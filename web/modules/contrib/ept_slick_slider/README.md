...
Extra Paragraph Types: Slick Slider module provides ability
to add a paragraph with Slick Slider.
https://kenwheeler.github.io/slick/
EPT Slick Slide also allows to display slideshows and carousels as well.

All Slick Slider options are available in paragraph settings
...
[project page](https://www.drupal.org/project/ept_slick_slider).

Submit bug reports and feature suggestions, or track changes in the
[issue queue](https://www.drupal.org/project/issues/ept_slick_slider).
