...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_basic_button'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_basic_button']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_basic_button');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_basic_button'));
