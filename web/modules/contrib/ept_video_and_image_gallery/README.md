...
Extra Paragraph Types: Video and Image Gallery module provides ability
to add grid gallery with videos and images.

For a full description of the module, visit the
[project page](https://www.drupal.org/project/ept_video_and_image_gallery).

Submit bug reports and feature suggestions, or track changes in the
[issue queue](https://www.drupal.org/project/issues/ept_video_and_image_gallery).
