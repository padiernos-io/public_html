...
namespace Drupal\Tests\ept_stats\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_stats'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_stats']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_stats');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_stats'));
