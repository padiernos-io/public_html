...
# Extra Paragraph Types (EPT): Webform

Extra Paragraph Types: Webform module provides ability
to add webform as a paragraph or button with form popup.

For a full description of the module, visit the
[project page](https://www.drupal.org/project/ept_webform).

Submit bug reports and feature suggestions, or track changes in the
[issue queue](https://www.drupal.org/project/issues/ept_webform).
...
You can use EPT Webform Popup module to display button
and show Webform popup on click:
