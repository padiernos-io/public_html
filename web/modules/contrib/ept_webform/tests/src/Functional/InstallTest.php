...
namespace Drupal\Tests\ept_webform\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_webform'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_webform']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_webform');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_webform'));
