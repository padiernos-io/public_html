...
namespace Drupal\Tests\ept_image\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_image'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_image']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_image');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_image'));
