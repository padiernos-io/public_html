...
class ComponentValidationTest extends BrowserTestBase {
  ...
  protected static $configSchemaCheckerExclusions = [
    // Leaflet has a bug where it defines certain formatter settings without
    // config schema to back them up. Since this only appears to affect the
    // 1.0.x branch of Drupal CMS, which is basically EOL, it's not worth fixing
    // and therefore we ignore it here.
